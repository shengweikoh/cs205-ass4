...
/**
 * Utility class to manage the selection and highlighting of UI elements for implementing
 * selection-based interactions. This is a singleton object that nests other util classes.
 */
object SelectionUtils {
    ...
    class SelectionManager<T>(
        ...
        fun cleanup() {
            ...
            selectableItems.keys.forEach { view -> view.setOnClickListener(null) }

            // Remove click listeners from all interaction targets
            interactionTargets.forEach { view -> view.setOnClickListener(null) }
